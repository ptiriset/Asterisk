...
if(isset($_GET['id']) && $_GET['id']!=""){
	$id=$_GET['id'];
	$page="edit";
	$q="SELECT * FROM features where id = $id ";
...
?>
  ...
  <body>
		...
		<input type="hidden" id="date" value="<? print $date;?>">
     ...
     <div class="sticky w3-bar w3-border-bottom w3-border-brown">
        ...
        <div class="colums"> 
		  <div class="item">
            ...
            <input type="text" id="code" name="code" value="<? print $code; ?>"  placeholder="code">
			<div id="code_msg" style="width:100%"></div>
          </div>
          <div class="item">
			<label for="feature"> Feature <span>*</span></label>
            <input type="text" id="feature" name="feature" value="<? print $feature; ?>"  placeholder="feature">
			<div id="feature_msg" style="width:100%"></div>
          </div>
          <div class="item">
          ...
          <div class="item">
            <label for="changes"> status <span>*</span></label>
            <select id="status" name="status" style="height:35px;padding:10px"  style="w3-padding" >
					<? 	$catList=array(	'Active','Suspended');
		  ...
		  <div class="item">
            ...
            <input type="text" id="remarks" name="remarks" value="<? print $remarks; ?>" placeholder="feature">
			<div id="remarks_msg" style="width:100%"></div>
          </div>
      ...
      <div class="btn-block w3-right">
		<? if ($id!=""){ ?>
				...
				<? } ?>
		<input id="submit" onclick="updateAdd('features');"  value="Save" class="w3-center w3-button w3-blue w3-text-white w3-hover-light-blue" >
